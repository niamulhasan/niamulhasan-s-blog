<template>
  <main>
        ...
        <div class="w-full max-w-6xl mx-auto pb-5">
          <div class="-mx-3 md:flex items-center">
            <div class="px-3 md:w-2/3 mb-10 md:mb-0">
              <h1 class="text-6xl md:text-8xl font-bold mb-5 leading-tight text-bn" style="font-weight: 100">
                    ...
                    <div class="max-w-md mx-auto my-3">
                      <ul class="grid grid-flow-col grid-cols-4 grid-rows-1 gap-4">
                        <li class="flex items-center">
                          <a href="https://facebook.com/nh360">
                            <div
                              class="
                                flex
                                justify-center
                        ...
                        <li class="flex items-center">
                          <a href="https://instagram.com/nhasan360">
                            <div
                              class="
                                flex
                                justify-center
                        ...
                        <li class="flex items-center">
                          <a href="https://youtube.com/startbit">
                            <div
                              class="
                                flex
                                justify-center
    ...
    <div v-if="posts">
      ...
      <!-- <div class="py-3 sm:max-w-xl sm:mx-auto md:mb-20">
